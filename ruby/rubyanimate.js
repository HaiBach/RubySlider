...
window.__rubyAnimateKeyframes__ = {
  ...
  bounceIn : [
    { pos: 0, perspectiveDirect: 1200, z: -3000, opacity: 0 },
    { pos: 50, z: 100, opacity: 1 },
    { pos: 75, z: -50 }
  ],

  roSlit : [
    { pos: 0, perspectiveDirect: 800, z: -3000, rotateY: 90, opacity: 0 },
  ...
  newspaperIn : [
    { pos: 0, perspectiveDirect: 1200, z: -3000, rotate: 1080, opacity: 0 },
    { pos: 100, z: 0, rotate: 0, opacity: 1, easing: 'easeOutQuart' }
  ],

  holeOut : [
    { pos: 100, perspectiveDirect: 800, z: -3000, rotateY: 180, opacity: 0 }
  ],

  holeIn : [
    { pos: 0, perspectiveDirect: 800, z: -3000, rotateY: -180, opacity: 0 }
  ],
  ...
  flipXIn : [
    { pos: 0, perspectiveDirect: 400, rotateX: 90, opacity: 0 },
  ...
  flipYIn : [
    { pos: 0, perspectiveDirect: 400, rotateY: 90, opacity: 0 },
  ...
  pullIn : [
    { pos: 0, perspectiveDirect: 1200, z: -2000, opacity: 0 }
  ],
  ...
  pushIn : [
    { pos: 0, perspectiveDirect: 1200, z: 500, opacity: 0 }
  ],
  ...
  perspectiveLeftIn : [
    { pos: 0, originTF: '0 50%', perspectiveDirect: 800, rotateY: -180, opacity: 0 }
  ],

  perspectiveRightIn : [
    { pos: 0, originTF: '100% 50%', perspectiveDirect: 800, rotateY: 180, opacity: 0 }
  ],

  perspectiveUpIn : [
    { pos: 0, originTF: '50% 0', perspectiveDirect: 800, rotateX: 180, opacity: 0 }
  ],

  perspectiveDownIn : [
    { pos: 0, originTF: '50% 100%', perspectiveDirect: 800, rotateX: -180, opacity: 0 }
  ],
   ...
   */
  moveLeftBehind : [
    { pos: 0, perspectiveDirect: 800, 'z-index': 9999 },
  ...
  moveLeftFront : [
    { pos: 0, perspectiveDirect: 800, opacity: 0, 'z-index': -1 },
  ...
  moveShortLeftFront : [
    { pos: 0, perspectiveDirect: 800, z: -400, opacity: 0 },
  ...
  slideTinLeftOut : [
    { pos: [0, 20, 40, 50], perspectiveDirect: 1200, z: 0 },
    { pos: [10, 30], z: 100 },
  ...
  slideTinLeftIn : [
    { pos: 0, perspectiveDirect: 1200, x: -1000, opacity: 0 },
  ...
  slideTinUpIn : [
    { pos: 0, perspectiveDirect: 1200, y: -1000, opacity: 0 },
  ...
  slideScaleLeftIn : [
    { pos: 0, perspectiveDirect: 1200, x: -2000, z: -400, opacity: 0 },
  ...
  slideScaleUpIn : [
    { pos: 0, perspectiveDirect: 1200, y: -2000, z: -400, opacity: 0 },
  ...
  slidePullLeftIn : [
    { pos: 0, perspectiveDirect: 1200, x: '-200%', z: -500, opacity: 0 },
    { pos: 25, opacity: 0.5 },
    { pos: 75, x: 0 }
  ],
  ...
  slidePullUpIn : [
    { pos: 0, perspectiveDirect: 1200, y: '-200%', z: -500, opacity: 0 },
    { pos: 25, opacity: 0.5 },
    { pos: 75, y: 0 }
  ],
  ...
  roLeftOut : [
    { pos: 0, originTF: '50% 50% -200px', perspectiveDirect: 800, z: -200 },
    { pos: 100, rotateY: -180, opacity: 0 }
  ],
  ...
  roUpOut : [
    { pos: 0, originTF: '50% 50% -150px', perspectiveDirect: 800, z: -150 },
    { pos: 100, rotateX: 180, opacity: 0 }
  ],
  ...
  roLeftIn : [
    { pos: 0, originTF: '50% 50% -200px', perspectiveDirect: 800, z: -200, rotateY: -180, opacity: 0 },
  ...
  roUpIn : [
    { pos: 0, originTF: '50% 50% -150px', perspectiveDirect: 800, z: -150, rotateX: 180, opacity: 0 },
  ...
  roSoftLeftIn :[
    { pos: 0, perspectiveDirect: 1200, x: '-20%', rotateZ: -10, rotateY: -40, z: 500, opacity: 0 },
  ...
  roTwistLeftOut : [
    { pos: 0, originTF: '50% 50% -400px', perspectiveDirect: 800, z: -400 },
  ...
  roTwistUpOut : [
    { pos: 0, originTF: '50% 50% -800px', perspectiveDirect: 800, z: -800 },
  ...
  roTwistLeftIn : [
    { pos: 0, originTF: '50% 50% -400px', perspectiveDirect: 800, x: '-200%', z: -400, rotateX: 1080, scale: 0, opacity: 0 },
  ...
  roTwistUpIn : [
    { pos: 0, originTF: '50% 50% -800px', perspectiveDirect: 800, y: '-200%', z: -800, rotateY: -1080, scale: 0, opacity: 0 },
  ...
  roFlitLeftOut : [
    { pos: [50, 100], perspectiveDirect: 800, z: -2000, rotateY: -90, opacity: 0.2 }
  ],
  ...
  roFlitUpOut : [
    { pos: [50, 100], perspectiveDirect: 800, z: -2000, rotateX: 90, opacity: 0.2 }
  ],
  ...
  roFlitLeftIn : [
    { pos: [0, 50], perspectiveDirect: 800, z: -2000, rotateY: -90, opacity: 0.2 }
  ],
  ...
  roFlitUpIn : [
    { pos: [0, 50], perspectiveDirect: 800, z: -2000, rotateX: 90, opacity: 0.2 }
  ],
  ...
  roFoldLeftOut : [
    { pos: 0, originTF: '100% 50%', perspectiveDirect: 1600 },
    { pos: 100, x: '-100%', rotateY: -70, opacity: 0 }
  ],

  roFoldRightOut : [
    { pos: 0, originTF: '0 50%', perspectiveDirect: 1600 },
    { pos: 100, x: '100%', rotateY: 70, opacity: 0 }
  ],

  roFoldUpOut : [
    { pos: 0, originTF: '50% 100%', perspectiveDirect: 1600 },
  ...
  roFoldLeftIn : [
    { pos: 0, originTF: '100% 50%', perspectiveDirect: 1600, x: '-100%', rotateY: -70, opacity: 0 }
  ],

  roFoldRightIn : [
    { pos: 0, originTF: '0 50%', perspectiveDirect: 1600, x: '100%', rotateY: 70, opacity: 0 }
  ],

  roFoldUpIn : [
    { pos: 0, originTF: '50% 100%', perspectiveDirect: 1600, y: '-100%', rotateX: 90, opacity: 0 }
  ],

  roFoldDownIn : [
    { pos: 0, originTF: '50% 0', perspectiveDirect: 1600, y: '100%', rotateX: -90, opacity: 0 }
  ],
  ...
  roRoomLeftOut : [
    { pos: 0, originTF: '100% 50%', perspectiveDirect: 1200 },
    { pos: 100, x: '-100%', rotateY: 90, opacity: 0 }
  ],

  roRoomRightOut : [
    { pos: 0, originTF: '0 50%', perspectiveDirect: 1200 },
    { pos: 100, x: '100%', rotateY: -90, opacity: 0 }
  ],

  roRoomUpOut : [
    { pos: 0, originTF: '50% 100%', perspectiveDirect: 1200 },
    { pos: 100, y: '-100%', rotateX: -90, opacity: 0 }
  ],

  roRoomDownOut : [
    { pos: 0, originTF: '50% 0', perspectiveDirect: 1200 },
    { pos: 100, y: '100%', rotateX: 90, opacity: 0 }
  ],

  roRoomLeftIn : [
    { pos: 0, originTF: '100% 50%', perspectiveDirect: 1200, x: '-100%', rotateY: 90, opacity: 0 }
  ],

  roRoomRightIn : [
    { pos: 0, originTF: '0 50%', perspectiveDirect: 1200, x: '100%', rotateY: -90, opacity: 0 }
  ],

  roRoomUpIn : [
    { pos: 0, originTF: '50% 100%', perspectiveDirect: 1200, y: '-100%', rotateX: -90, opacity: 0 }
  ],

  roRoomDownIn : [
    { pos: 0, originTF: '50% 0', perspectiveDirect: 1200, y: '100%', rotateX: 90, opacity: 0 }
  ],
  ...
  roEdgeLeftIn : [
    { pos: 0, originTF: '0 50%', perspectiveDirect: 1200, rotateY: 90 }
  ],

  roEdgeRightIn : [
    { pos: 0, originTF: '100% 50%', perspectiveDirect: 1200, rotateY: -90 }
  ],

  roEdgeUpIn : [
    { pos: 0, originTF: '50% 0', perspectiveDirect: 1200, rotateX: -90 }
  ],

  roEdgeDownIn : [
    { pos: 0, originTF: '50% 100%', perspectiveDirect: 1200, rotateX: 90 }
  ],
  ...
  roShortPushLeftIn : [
    { pos: 0, perspectiveDirect: 1200, z: 400, rotate: 45, opacity: 0 },
  ...
  roShortPullLeftIn : [
    { pos: 0, perspectiveDirect: 1200, z: -2000, rotate: 45, opacity: 0 },
   ...
   */
  wave : [
    { pos: [0, 100], perspectiveDirect: 800, z: 0 },
    { pos: [25, 75], z: -100 },
    { pos: 50, z: 100 }
  ],

  juggle : [
    { pos: [0, 100], perspectiveDirect: 800, z: 0, rotateY: 0 },
